...
MN2_warp_model = My_nequin(opt, 3)
print(MN2_warp_model)
MN2_warp_model.train()
MN2_warp_model.cuda()
load_checkpoint_part_parallel(MN2_warp_model, opt.MN1_warp_checkpoint)
...
# optimizer
params = [p for p in MN2_warp_model.parameters()]
optimizer = torch.optim.Adam(params, lr=opt.lr, betas=(opt.beta1, 0.999))

params_part = []
for name, param in MN2_warp_model.named_parameters():
...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    if epoch > opt.niter:
        MN2_warp_model.module.update_learning_rate(optimizer)
